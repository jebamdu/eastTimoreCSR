...
export class SidebarComponent implements OnChanges, OnInit {
  ...
  public ChatBotSideBarData = [{ id: 1, values: 'Training', img: '', navigateValue: 'chatbot/traininglist' }, { id: 2, values: 'Job Offers', img: '', navigateValue: '' }, { id: 3, values: 'Learnings - upskill', img: '', navigateValue: '' }, { id: 7, values: 'EBooks', img: '', navigateValue: '' }, { id: 4, values: 'Help Line', img: '', navigateValue: '' }, { id: 5, values: 'Configuration', img: '', navigateValue: '' }, { id: 6, values: 'Template Message', img: '', navigateValue: '' }]
